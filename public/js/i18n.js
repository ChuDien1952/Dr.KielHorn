  ...
  en: {
    ...
    team: {
      ...
      doctor: {
        ...
        desc1: 'Christopher Kielhorn comes from one of the oldest dental families in Winsen (Luhe) and is already practising as a dentist in the 3rd generation. As the son of Dr. Wilhelm Kielhorn and Ingrid Schierz-Kielhorn, he literally grew up with dentistry — the passion for this profession is in his blood.',
        desc2: 'Before his studies, he worked as a paramedic and completed training as a dental technician. This combination of medical experience, practical skill and technical understanding gives him a perspective that is perceptible in his daily work.',
    ...
    a11y: {
      ...
      hero_desc: 'Our commitment to digital accessibility for all users.',
      tag_date: 'As of: May 2025',
      status_h3: 'Conformance Status',
      status_p: 'This website is <strong>largely conformant</strong> with the requirements of WCAG 2.1 Level AA. Known limitations are listed below.',
      h2_1: 'Non-Accessible Content',
      h2_2: 'Creation of This Statement',
      h2_3: 'Measures to Promote Accessibility',
      h2_4: 'Contact and Feedback',
      h2_5: 'Dispute Resolution',
      h2_6: 'Technical Specifications',
      check_1: 'All interactive elements operable via keyboard',
      check_2: 'Meaningful alt texts for all relevant images',
      check_3: 'Semantic HTML with ARIA roles and labels',
      check_4: 'Skip link "Skip to content" at the top of the page',
      check_5: 'Sufficient colour contrasts (WCAG AA)',
      check_6: 'Responsive layout for all screen sizes',
      check_7: 'Font size scalable via user preferences',
      check_8: 'Animations respect prefers-reduced-motion',
      check_9: 'Form fields with correct labels',
      check_10: 'Clearly visible focus states for keyboard navigation',
      p1: 'The following content is not accessible:',
      li1_1: 'Embedded Google Maps: Full keyboard control is outside our sphere of influence (third-party provider). As an alternative, we provide the address in text format.',
      li1_2: 'Older PDF documents (if any): May not be fully accessible. Please contact us for an accessible alternative.',
      li1_3: 'Certain colour contrasts in images: Background images in the hero area may be difficult to perceive at very low system contrast settings.',
      p2: 'This statement was created on 4 May 2025 and is regularly reviewed. The assessment is based on a self-assessment using the following methods:',
      li2_1: 'Automated testing with common inspection tools (axe, WAVE)',
      li2_2: 'Manual checking of keyboard navigation',
      li2_3: 'Verification of colour contrast ratios (WCAG 1.4.3: minimum contrast 4.5:1)',
      li2_4: 'Review of ARIA attributes and semantic HTML structure',
      p3: 'We have implemented the following measures to ensure the accessibility of our website:',
      p4: 'If you encounter barriers on our website or need information in another format, please contact us:',
      addr: 'Dr. med. dent. Christopher Kielhorn<br>Niedersachsenstraße 13a, 21423 Winsen (Luhe)<br>Phone: <a href="tel:+494171712120">04171 / 71212</a><br>Email: <a href="mailto:info@zahnarzt-kielhorn-winsen.de">info@zahnarzt-kielhorn-winsen.de</a>',
      p5: 'We will review your request and respond within 5 working days.',
      p6: 'If you have not received a satisfactory response after contacting us, you can refer the matter to the arbitration board:',
      p7: 'Arbitration body pursuant to § 16 BGG: Federal Commissioner for Data Protection and Freedom of Information<br>Graurheindorfer Str. 153, 53117 Bonn · Phone: 0228 / 997799-0<br><a href="https://www.bfdi.bund.de" target="_blank" rel="noopener noreferrer">www.bfdi.bund.de</a>',
      p8: 'The accessibility of this website relies on: HTML5 (semantic), CSS3 with Custom Properties, JavaScript (ES6+, progressive) and WAI-ARIA (Web Accessibility Initiative — Accessible Rich Internet Applications).',
      date_stamp: 'As of: May 2025'
    },
    imp: {
      title: 'Legal Notice',
      hero_desc: 'Information pursuant to § 5 TMG — Responsible operator of this website.',
      addr_label: 'Address',
      contact_label: 'Contact',
      h2_1: 'Information pursuant to § 5 TMG',
      h2_2: 'Professional Title and Regulations',
      h2_3: 'VAT Identification Number',
      h2_4: 'Dispute Resolution',
      h2_5: 'Liability for Content',
      h2_6: 'Liability for Links',
      h2_7: 'Copyright',
      p_profession: 'Professional title: Dentist (awarded in Germany)',
      p_chamber: 'Competent chamber: Dental Chamber of Lower Saxony<br>August-Rother-Straße 8, 30659 Hannover · Phone: 0511 / 83391-0<br>Website: <a href="https://www.zkn.de" target="_blank" rel="noopener noreferrer">www.zkn.de</a>',
      p_supervisor: 'Competent supervisory authority: Dental Chamber of Lower Saxony',
      p_regulations: 'Professional regulations: Code of conduct of the Dental Chamber of Lower Saxony — available at <a href="https://www.zkn.de" target="_blank" rel="noopener noreferrer">www.zkn.de</a>',
      p_vat: 'VAT identification number pursuant to § 27a of the VAT Act: available on request.',
      p_dispute1: 'The European Commission provides a platform for online dispute resolution (ODR): <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer">ec.europa.eu/consumers/odr/</a>',
      p_dispute2: 'We are neither willing nor obligated to participate in dispute resolution proceedings before a consumer arbitration board.',
      p_liability1: 'As a service provider, we are responsible for our own content on these pages in accordance with § 7 para. 1 TMG under general law. According to §§ 8 to 10 TMG, however, we are not obligated to monitor transmitted or stored third-party information.',
      p_liability2: 'Obligations to remove or block the use of information under general law remain unaffected. Liability is only possible from the time of knowledge of a specific infringement. Upon becoming aware of such violations, we will remove the relevant content immediately.',
      p_links1: 'Our website contains links to external third-party websites over whose content we have no influence. The respective provider or operator is always responsible for the content of the linked pages. The linked pages were checked for possible legal violations at the time of linking.',
      p_links2: 'Permanent monitoring of linked pages is not reasonable without concrete evidence of a legal violation. Upon becoming aware of legal violations, we will remove such links immediately.',
      p_copyright1: 'The content and works created by the site operators on these pages are subject to German copyright law. Reproduction, processing, and distribution outside the limits of copyright law require the written consent of the respective author.',
      p_copyright2: 'Downloads and copies are only permitted for private, non-commercial use. Upon becoming aware of legal violations, we will remove such content immediately.'
    },
    ds: {
      title: 'Privacy Policy',
      hero_desc: 'Information pursuant to the GDPR on the protection of your personal data.',
      tag_gdpr: 'GDPR compliant',
      toc_header: 'Contents',
      toc_1: '1. Privacy at a Glance',
      toc_2: '2. Controller',
      toc_3: '3. Hosting',
      toc_4: '4. Contact Form',
      toc_5: '5. Enquiries',
      toc_6: '6. Patient Data',
      toc_7: '7. Google Fonts',
      toc_8: '8. Google Maps',
      toc_9: '9. Your Rights',
      toc_10: '10. Data Security',
      h2_1: '1. Privacy at a Glance',
      h2_2: '2. Controller',
      h2_3: '3. Hosting and Technical Operation',
      h2_4: '4. Contact Form',
      h2_5: '5. Enquiries by Email, Phone or Fax',
      h2_6: '6. Patient Data',
      h2_7: '7. Google Fonts',
      h2_8: '8. Google Maps',
      h2_9: '9. Your Rights',
      ...
      p1_1: 'The following notes provide a simple overview of what happens to your personal data when you visit this website. Personal data is any data by which you can be personally identified.',
      p1_2: '<strong>Who is responsible?</strong> Data processing is carried out by the website operator. Their contact details can be found in the section "Controller".',
      p1_3: '<strong>How do we collect your data?</strong> Your data is collected when you provide it to us (e.g. via our contact form). Other data is collected automatically when you visit the website.',
      p1_4: '<strong>What do we use your data for?</strong> Part of the data is collected to ensure the error-free provision of the website. Other data may be used to analyse user behaviour, provided you have consented.',
      p2_intro: 'The controller within the meaning of the GDPR is:',
      addr1: 'Dr. med. dent. Christopher Kielhorn<br>Niedersachsenstraße 13a, 21423 Winsen (Luhe)<br>Phone: <a href="tel:+494171712120">04171 / 71212</a><br>Email: <a href="mailto:info@zahnarzt-kielhorn-winsen.de">info@zahnarzt-kielhorn-winsen.de</a>',
      p3_1: 'This website is hosted externally. The personal data collected is stored on the hoster\'s servers — in particular IP addresses, contact requests, and website access logs.',
      p3_2: 'Processing is based on Art. 6(1)(f) GDPR (legitimate interests) and for the fulfilment of contracts pursuant to Art. 6(1)(b) GDPR.',
      p4_1: 'If you send us enquiries via the contact form, your details including the contact information provided will be stored by us for the purpose of processing the request. We do not pass on this data without your consent.',
      p4_2: 'Processing is based on Art. 6(1)(b) GDPR (performance of contract) or Art. 6(1)(f) GDPR (legitimate interest in effectively processing enquiries).',
      p4_3: 'The data you enter will remain with us until you request its deletion or the purpose for storing the data no longer applies.',
      p5_1: 'If you contact us by email, phone or fax, your request including all personal data will be stored and processed for the purpose of handling your enquiry. We do not pass on this data without your consent.',
      p5_2: 'Processing of this data is based on Art. 6(1)(b) GDPR.',
      p6_1: 'As a dental practice, we process health data (special categories pursuant to Art. 9 GDPR) within the context of the treatment relationship. Processing is based on Art. 9(2)(h) GDPR and § 22(1)(1)(b) BDSG. We are subject to medical confidentiality pursuant to § 203 StGB.',
      p7_1: 'This page uses Google Fonts for uniform display of fonts. When the page loads, your browser loads the required fonts from the browser cache. For this purpose, your browser makes a connection to Google\'s servers.',
      p7_2: 'Use is in the interest of a uniform presentation (Art. 6(1)(f) GDPR). Further information: <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer">developers.google.com/fonts/faq</a> · <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a>',
      p8_1: 'This page uses Google Maps (Google Ireland Limited, Gordon House, Dublin 4, Ireland). Use requires your IP address to be stored; this information is generally transmitted to Google servers in the USA.',
      p8_2: 'Use is in the interest of an appealing presentation and easy location of our practice (Art. 6(1)(f) GDPR).',
      p9_1: 'You have the right to free information about the origin, recipient and purpose of your stored personal data at any time, as well as the right to correction or deletion. You can revoke consent granted at any time for the future and, under certain circumstances, have the right to restrict processing.',
      p9_intro: 'Competent supervisory authority in Lower Saxony:',
      addr2: 'State Commissioner for Data Protection in Lower Saxony<br>Prinzenstraße 5, 30159 Hannover<br>Phone: 0511 / 120-4500<br><a href="https://www.lfd.niedersachsen.de" target="_blank" rel="noopener noreferrer">www.lfd.niedersachsen.de</a>',
      p10_1: 'This site uses SSL or TLS encryption to protect the transmission of confidential content. You can recognise an encrypted connection by the "https://" in the address bar and the padlock symbol in your browser.',
      date_stamp: 'As of: May 2025'
    }
  },
  ...
  de: {
    ...
    team: {
      ...
      doctor: {
        ...
        name: 'Christopher Kielhorn',
        desc1: 'Christopher Kielhorn entstammt einer der ältesten Zahnarztfamilien in Winsen (Luhe) und der Region und ist bereits in 3. Generation als Zahnarzt tätig. Als Sohn von Dr. Wilhelm Kielhorn und Ingrid Schierz-Kielhorn wuchs er buchstäblich mit der Zahnmedizin auf — die Leidenschaft für diesen Beruf liegt ihm im Blut.',
        desc2: 'Vor dem Studium arbeitete er als Rettungssanitäter und absolvierte eine Ausbildung zum Zahntechniker. Diese Kombination aus medizinischer Erfahrung, handwerklichem Können und technischem Verständnis gibt ihm einen Blickwinkel, der in seiner täglichen Arbeit spürbar ist.',
    ...
    a11y: {
      ...
      hero_desc: 'Unsere Verpflichtung zur digitalen Zugänglichkeit für alle Nutzerinnen und Nutzer.',
      tag_date: 'Stand: Mai 2025',
      status_h3: 'Konformitätsstatus',
      status_p: 'Diese Website ist mit den Anforderungen der WCAG 2.1 Konformitätsstufe AA <strong>größtenteils vereinbar</strong>. Bekannte Einschränkungen sind nachstehend aufgeführt.',
      h2_1: 'Nicht barrierefreie Inhalte',
      h2_2: 'Erstellung dieser Erklärung',
      h2_3: 'Maßnahmen zur Förderung der Barrierefreiheit',
      h2_4: 'Kontakt und Feedback',
      h2_5: 'Schlichtungsverfahren',
      h2_6: 'Technische Spezifikationen',
      check_1: 'Alle interaktiven Elemente per Tastatur bedienbar',
      check_2: 'Sinnvolle Alt-Texte für alle relevanten Bilder',
      check_3: 'Semantisches HTML mit ARIA-Rollen und -Labels',
      check_4: 'Skip-Link „Zum Inhalt springen" am Seitenanfang',
      check_5: 'Ausreichende Farbkontraste (WCAG AA)',
      check_6: 'Responsive Layout für alle Bildschirmgrößen',
      check_7: 'Schriftgröße in Benutzereinstellungen skalierbar',
      check_8: 'Animationen respektieren prefers-reduced-motion',
      check_9: 'Formularfelder mit korrekten Labels versehen',
      check_10: 'Klar erkennbare Fokuszustände für Tastaturnavigation',
      p1: 'Die nachstehend aufgeführten Inhalte sind nicht barrierefrei:',
      li1_1: 'Eingebettete Google Maps-Karte: Vollständige Tastatursteuerung liegt außerhalb unseres Einflussbereichs (Drittanbieter). Als Alternative bieten wir die Adresse im Textformat an.',
      li1_2: 'Ältere PDF-Dokumente (sofern vorhanden): Möglicherweise nicht vollständig barrierefrei. Bitte kontaktieren Sie uns für eine zugängliche Alternative.',
      li1_3: 'Bestimmte Farbkontraste in Bildern: Hintergrundbilder im Hero-Bereich können bei sehr geringem Systemkontrast schwer erkennbar sein.',
      p2: 'Diese Erklärung wurde am 4. Mai 2025 erstellt und wird regelmäßig überprüft. Die Bewertung basiert auf einer Selbstbewertung mit folgenden Methoden:',
      li2_1: 'Automatische Tests mit gängigen Prüfwerkzeugen (axe, WAVE)',
      li2_2: 'Manuelle Prüfung der Tastaturnavigation',
      li2_3: 'Prüfung der Kontrastverhältnisse (WCAG 1.4.3: Mindestkontrast 4,5:1)',
      li2_4: 'Überprüfung der ARIA-Attribute und semantischen HTML-Struktur',
      p3: 'Wir haben folgende Maßnahmen umgesetzt, um die Zugänglichkeit unserer Website zu gewährleisten:',
      p4: 'Wenn Sie auf Barrieren auf unserer Website stoßen oder Informationen in einer anderen Form benötigen, wenden Sie sich bitte an uns:',
      addr: 'Dr. med. dent. Christopher Kielhorn<br>Niedersachsenstraße 13a, 21423 Winsen (Luhe)<br>Telefon: <a href="tel:+494171712120">04171 / 71212</a><br>E-Mail: <a href="mailto:info@zahnarzt-kielhorn-winsen.de">info@zahnarzt-kielhorn-winsen.de</a>',
      p5: 'Wir werden Ihre Anfrage prüfen und innerhalb von 5 Werktagen antworten.',
      p6: 'Wenn Sie nach einer Kontaktaufnahme keine zufriedenstellende Antwort erhalten haben, können Sie sich an die Schlichtungsstelle wenden:',
      p7: 'Schlichtungsstelle nach § 16 BGG: Bundesbeauftragte für den Datenschutz und die Informationsfreiheit<br>Graurheindorfer Str. 153, 53117 Bonn · Telefon: 0228 / 997799-0<br><a href="https://www.bfdi.bund.de" target="_blank" rel="noopener noreferrer">www.bfdi.bund.de</a>',
      p8: 'Die Zugänglichkeit dieser Website stützt sich auf: HTML5 (semantisch), CSS3 mit Custom Properties, JavaScript (ES6+, progressiv) sowie WAI-ARIA (Web Accessibility Initiative — Accessible Rich Internet Applications).',
      date_stamp: 'Stand: Mai 2025'
    },
    imp: {
      title: 'Impressum',
      hero_desc: 'Angaben gemäß § 5 TMG — Verantwortlicher Betreiber dieser Website.',
      addr_label: 'Adresse',
      contact_label: 'Kontakt',
      h2_1: 'Angaben gemäß § 5 TMG',
      h2_2: 'Berufsbezeichnung und berufsrechtliche Regelungen',
      h2_3: 'Umsatzsteuer-ID',
      h2_4: 'Streitschlichtung',
      h2_5: 'Haftung für Inhalte',
      h2_6: 'Haftung für Links',
      h2_7: 'Urheberrecht',
      p_profession: 'Berufsbezeichnung: Zahnarzt (verliehen in Deutschland)',
      p_chamber: 'Zuständige Kammer: Zahnärztekammer Niedersachsen<br>August-Rother-Straße 8, 30659 Hannover · Telefon: 0511 / 83391-0<br>Internet: <a href="https://www.zkn.de" target="_blank" rel="noopener noreferrer">www.zkn.de</a>',
      p_supervisor: 'Zuständige Aufsichtsbehörde: Zahnärztekammer Niedersachsen',
      p_regulations: 'Berufsrechtliche Regelungen: Berufsordnung der Zahnärztekammer Niedersachsen — einsehbar unter <a href="https://www.zkn.de" target="_blank" rel="noopener noreferrer">www.zkn.de</a>',
      p_vat: 'Umsatzsteuer-Identifikationsnummer gemäß § 27a Umsatzsteuergesetz: wird auf Anfrage mitgeteilt.',
      p_dispute1: 'Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer">ec.europa.eu/consumers/odr/</a>',
      p_dispute2: 'Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.',
      p_liability1: 'Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen.',
      p_liability2: 'Verpflichtungen zur Entfernung oder Sperrung nach den allgemeinen Gesetzen bleiben hiervon unberührt. Eine Haftung ist erst ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung möglich. Bei Bekanntwerden von Rechtsverletzungen werden wir diese Inhalte umgehend entfernen.',
      p_links1: 'Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Für die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf mögliche Rechtsverstöße überprüft.',
      p_links2: 'Eine permanente inhaltliche Kontrolle ist ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen.',
      p_copyright1: 'Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung und Verbreitung außerhalb der Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors.',
      p_copyright2: 'Downloads und Kopien sind nur für den privaten, nicht kommerziellen Gebrauch gestattet. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.'
    },
    ds: {
      title: 'Datenschutzerklärung',
      hero_desc: 'Informationen gemäß DSGVO zum Schutz Ihrer personenbezogenen Daten.',
      tag_gdpr: 'DSGVO-konform',
      toc_header: 'Inhalt',
      toc_1: '1. Datenschutz auf einen Blick',
      toc_2: '2. Verantwortlicher',
      toc_3: '3. Hosting',
      toc_4: '4. Kontaktformular',
      toc_5: '5. Anfragen',
      toc_6: '6. Patientendaten',
      toc_7: '7. Google Fonts',
      toc_8: '8. Google Maps',
      toc_9: '9. Ihre Rechte',
      toc_10: '10. Datensicherheit',
      h2_1: '1. Datenschutz auf einen Blick',
      h2_2: '2. Verantwortlicher',
      h2_3: '3. Hosting und technischer Betrieb',
      h2_4: '4. Kontaktformular',
      h2_5: '5. Anfragen per E-Mail, Telefon oder Telefax',
      h2_6: '6. Patientendaten',
      h2_7: '7. Google Fonts',
      h2_8: '8. Google Maps',
      h2_9: '9. Ihre Rechte',
      h2_10: '10. Datensicherheit',
      h3_1: 'Allgemeine Hinweise',
      h3_2: 'Datenerfassung auf dieser Website',
      p1_1: 'Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.',
      p1_2: '<strong>Wer ist verantwortlich?</strong> Die Datenverarbeitung erfolgt durch den Websitebetreiber. Dessen Kontaktdaten finden Sie im Abschnitt „Verantwortlicher".',
      p1_3: '<strong>Wie erfassen wir Ihre Daten?</strong> Ihre Daten werden erhoben, wenn Sie uns diese mitteilen (z. B. über unser Kontaktformular). Andere Daten werden automatisch beim Besuch der Website erfasst.',
      p1_4: '<strong>Wofür nutzen wir Ihre Daten?</strong> Ein Teil der Daten wird zur fehlerfreien Bereitstellung der Website erhoben. Andere Daten können zur Analyse des Nutzerverhaltens verwendet werden, sofern Sie zugestimmt haben.',
      p2_intro: 'Verantwortlicher im Sinne der DSGVO ist:',
      addr1: 'Dr. med. dent. Christopher Kielhorn<br>Niedersachsenstraße 13a, 21423 Winsen (Luhe)<br>Telefon: <a href="tel:+494171712120">04171 / 71212</a><br>E-Mail: <a href="mailto:info@zahnarzt-kielhorn-winsen.de">info@zahnarzt-kielhorn-winsen.de</a>',
      p3_1: 'Diese Website wird extern gehostet. Die erfassten personenbezogenen Daten werden auf den Servern des Hosters gespeichert — insbesondere IP-Adressen, Kontaktanfragen sowie Websitezugriffe.',
      p3_2: 'Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse) und zur Vertragserfüllung nach Art. 6 Abs. 1 lit. b DSGVO.',
      p4_1: 'Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben einschließlich der Kontaktdaten zwecks Bearbeitung der Anfrage bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.',
      p4_2: 'Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung) oder Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an effektiver Bearbeitung von Anfragen).',
      p4_3: 'Die von Ihnen eingegebenen Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern oder der Zweck der Datenspeicherung entfällt.',
      p5_1: 'Wenn Sie uns per E-Mail, Telefon oder Telefax kontaktieren, wird Ihre Anfrage inklusive aller personenbezogenen Daten zum Zwecke der Bearbeitung Ihres Anliegens gespeichert und verarbeitet. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.',
      p5_2: 'Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO.',
      p6_1: 'Als Zahnarztpraxis verarbeiten wir im Rahmen des Behandlungsverhältnisses Gesundheitsdaten (besondere Kategorien gemäß Art. 9 DSGVO). Die Verarbeitung erfolgt auf Basis von Art. 9 Abs. 2 lit. h DSGVO sowie § 22 Abs. 1 Nr. 1 lit. b BDSG. Wir unterliegen der ärztlichen Schweigepflicht gemäß § 203 StGB.',
      p7_1: 'Diese Seite nutzt Google Fonts zur einheitlichen Darstellung von Schriftarten. Beim Aufruf lädt Ihr Browser die benötigten Fonts aus dem Browsercache. Zu diesem Zweck nimmt Ihr Browser Verbindung zu den Servern von Google auf.',
      p7_2: 'Die Nutzung erfolgt im Interesse einer einheitlichen Darstellung (Art. 6 Abs. 1 lit. f DSGVO). Weitere Informationen: <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer">developers.google.com/fonts/faq</a> · <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a>',
      p8_1: 'Diese Seite nutzt Google Maps (Google Ireland Limited, Gordon House, Dublin 4, Irland). Zur Nutzung ist es notwendig, Ihre IP-Adresse zu speichern; diese Informationen werden in der Regel an Google-Server in den USA übertragen.',
      p8_2: 'Die Nutzung erfolgt im Interesse einer ansprechenden Darstellung und leichten Auffindbarkeit unserer Praxis (Art. 6 Abs. 1 lit. f DSGVO).',
      p9_1: 'Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Herkunft, Empfänger und Zweck Ihrer gespeicherten personenbezogenen Daten sowie das Recht auf Berichtigung oder Löschung. Sie können eine erteilte Einwilligung jederzeit für die Zukunft widerrufen und haben unter bestimmten Umständen das Recht auf Einschränkung der Verarbeitung.',
      p9_intro: 'Zuständige Aufsichtsbehörde in Niedersachsen:',
      addr2: 'Die Landesbeauftragte für den Datenschutz Niedersachsen<br>Prinzenstraße 5, 30159 Hannover<br>Telefon: 0511 / 120-4500<br><a href="https://www.lfd.niedersachsen.de" target="_blank" rel="noopener noreferrer">www.lfd.niedersachsen.de</a>',
      p10_1: 'Diese Seite nutzt SSL- bzw. TLS-Verschlüsselung zum Schutz der Übertragung vertraulicher Inhalte. Eine verschlüsselte Verbindung erkennen Sie am „https://" in der Adresszeile und dem Schloss-Symbol in Ihrem Browser.',
      date_stamp: 'Stand: Mai 2025'
    }
  }
};
